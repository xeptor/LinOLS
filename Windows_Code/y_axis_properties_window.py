...
class y_axis_properties:
    def __init__(self, ui):
        self.ui = ui

    def y_axis_properties_dialog(self):
    ...
    def insert_all_info(self):
        ...
        with open(file_path, 'r') as file:
            ...
            map_factor = content[(index * 10) + 8]
            map_precision = content[(index * 10) + 9]
    ...
    def apply_changes(self):
        ...
        content[index + 8] = str(new_map_factor)
        content[index + 9] = str(new_map_precision)
    ...
    def show_context_menu(self, event):
        self.ui.right_click_y_axis.post(event.x_root, event.y_root)
